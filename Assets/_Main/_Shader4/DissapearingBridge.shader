...
Shader "DissapearingBridge"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 appendResult56 = (float3(ase_worldPos.x , 0.0 , ase_worldPos.z));
			float temp_output_65_0 = saturate( pow( ( distance( _PlayerPosition , appendResult56 ) / _Radius ) , ( _FallOff * 1000000.0 ) ) );
			v.vertex.xyz += ( temp_output_65_0 * float3(0,-1,0) * _Height );
			v.vertex.w = 1;
		}
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 appendResult56 = (float3(ase_worldPos.x , 0.0 , ase_worldPos.z));
			float temp_output_65_0 = saturate( pow( ( distance( _PlayerPosition , appendResult56 ) / _Radius ) , ( _FallOff * 1000000.0 ) ) );
			float4 lerpResult17 = lerp( tex2D( _TextureSample0, uv_TextureSample0 ) , tex2D( _TextureSample1, ( (ase_worldPos).xz * 0.05 ) ) , temp_output_65_0);
...
/*ASEBEGIN
Version=18900
8;81;1394;950;537.1437;531.5418;1.002026;False;False
Node;AmplifyShaderEditor.WorldPosInputsNode;2;-1099.076,173.7655;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.Vector3Node;1;-947.1219,9.166277;Inherit;False;Property;_PlayerPosition;PlayerPosition;0;0;Create;True;0;0;0;False;0;False;0,0,0;0,1.192093E-07,-23.02;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;53;-926.767,463.1695;Inherit;False;Constant;_Float2;Float 2;5;0;Create;True;0;0;0;False;0;False;1000000;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;65;-166.9546,142.787;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;37;-131.5941,-335.8942;Inherit;True;Property;_TextureSample1;Texture Sample 1;5;0;Create;True;0;0;0;False;0;False;-1;None;3026c5f48ed81264585300397ccdb5e7;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=8D2B33DF3F7A4D6C290EF004E4651E97184103AE